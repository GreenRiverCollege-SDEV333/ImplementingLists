...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> nemesis = new Arraylist<>(8);
        System.out.println();
        System.out.println("Friends ArrayList initial size is " + friends.size());
        System.out.println("Is friends array list currently empty:"+friends.isEmpty());
        System.out.println("Nemesis initial size is " +nemesis.size());
        ...
        System.out.println("Is friends array list still empty:"+friends.isEmpty());
        System.out.println();
        ...
        System.out.println("The friends Array list returns true if Jess in found within: " +friends.contains("Jess"));
